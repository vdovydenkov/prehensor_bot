...
DEFAULT_RAW_CONFIG = {
    ...
    "msg": {
        ...
        "help_text": (
            ...
            "/help       Этот текст.\n"
            "<ссылка>    Получить краткую информацию о медиа по ссылке. При этом ссылка сохраняется в памяти бота.\n"
            "/info       Подробная информация о медиа. Если ссылку после команды не указать, то она будет взята из памяти бота.\n"
